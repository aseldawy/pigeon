...
import edu.umn.cs.pigeon.Envelope;
...
public class TestEnvelope extends TestCase {
  ...
  public void testShouldWorkWithWKT() throws Exception {
    ...
    while (it.hasNext() && geoms.hasNext()) {
      ...
      OGCGeometry trueEnvelope = geom.envelope();
      Tuple tuple = (Tuple) it.next();
      if (tuple == null)
        break;
      OGCGeometry calculatedEnvelope = geom_parser.parseGeom(tuple.get(0));
      assertTrue(trueEnvelope.equals(calculatedEnvelope));
    }
  }
